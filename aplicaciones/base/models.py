...
class Autor(ModeloBase):
    ...
    instagran = models.URLField('Instagram', null=True, blank=True)
...
class Contacto(ModeloBase):
    ...
    correo = models.EmailField('Correo Electrónico', max_length=100)
...
class Suscriptores(ModeloBase):
    correo = models.EmailField('Correco Electrónico', max_length=200)
